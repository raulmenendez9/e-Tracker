...
class HomeTravelFragment : Fragment(), AdapterHomeTravel.ShowDataInterface {
    ...
    private fun adapterInit(): FirestoreRecyclerOptions<Record> { //inicializador para el adapter del recyclerview
        val query: Query =
            travelRef.document("dummyData") //Se le pone "dummyData" por que no nos interesa que jale datos desde firebase ya que para eso necesitamos el id
    ...
    private fun fillForm() { //metodo para llenar la cabecera de info del viaje y el recycler
        ...
        travelRef
            ...
            .addOnSuccessListener { doc ->
                ...
                initDate!!.text =
                    data[0].initialDate!!.substring(0, data[0].initialDate!!.length - 5)
                finishDate!!.text =
                ...
                travelRef.document(idTravel!!)
                    ...
                    .addOnSuccessListener { querySnapShot ->
                        ...
                        val balanceReg =
                            data[0].balance!!.toDouble() - totalFoodC - totalCarC - totalhotelC - totalOtherC
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(id: String): HomeTravelFragment {
